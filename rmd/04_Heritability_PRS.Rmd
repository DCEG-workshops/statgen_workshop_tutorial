...
<!-- TODO
- `input_dir` (line ~20): `drive/MyDrive/statgen_workshop_04Heritability_PRS/` is a Colab path — update to real Biowulf data path
- Google Drive mount instructions in prose (line ~13): Update to reflect Biowulf data setup
- `conda install` commands: On Biowulf, use `module load` for gcta, plink, plink2, ldsc if available
-->
