...
<!-- TODO
- `input_dir` (line ~15): `drive/MyDrive/statgen_workshop_04Heritability_PRS/` is an incomplete Colab path — update to real data path
- `analysis_dir` is already set to `$(pwd)/04_analysis/` which is portable — no change needed
-->
