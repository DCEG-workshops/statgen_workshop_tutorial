...
<!-- TODO
- `input_dir` (line ~18): Update `/content/drive/MyDrive/statgen_workshop/data/workshop9` to real Biowulf data path
- `ls /content/drive/MyDrive/...` (line ~20): Update to use `${input_dir}` after path is set, or reorder chunks
...
- BAM paths inside igv_notebook Python chunk reference `/content/09_analysis/` — update to match `analysis_dir`
-->
...
```{bash}
export analysis_dir="$(pwd)/09_analysis/"
