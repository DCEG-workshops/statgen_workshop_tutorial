...
<!-- TODO
- Line ~128: Commented-out path `/content/drive/MyDrive/` — update to real output path if you want to save results
-->
...
```{bash}
export input_dir="drive/MyDrive/statgen_workshop/data/workshop1/inputs/penncath_withPheno"
export analysis_dir="$(pwd)/02_analysis/"
export reference_dir="drive/MyDrive/statgen_workshop/data/workshop1/inputs/ref/"
```
...
```{bash}
#cp -r ${analysis_dir} /YOUR/OUTPUT/PATH/
```
