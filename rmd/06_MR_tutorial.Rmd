...
<!-- TODO
- `input_dir` (line ~18): Update `/content/drive/MyDrive/statgen_workshop/data/workshop6/data/MR/` to real Biowulf data path
...
- `apt install libgmp-dev` (line ~32): On Biowulf, use `module load` or pre-installed system libraries instead
- Text on line ~39 references "Google colab" — update to reflect Biowulf environment
-->
...
```{bash}
export analysis_dir="$(pwd)/06_analysis/"
