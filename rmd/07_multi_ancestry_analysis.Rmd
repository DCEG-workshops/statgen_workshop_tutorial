...
<!-- TODO
- `input_dir` (line ~9): `drive/MyDrive/statgen_workshop/data/workshop7/` is a Colab path — update to real Biowulf data path
...
- `apt-get install libgsl-dev libmpfr-dev` (line ~33): On Biowulf, use `module load` or pre-installed system libraries instead
- Text referencing "colab runtime" (line ~398): Update to reflect Biowulf environment
-->
...
```{r}
system(paste0("./MsCAVIAR/MsCAVIAR -l ",
